 ...
 function ProductImage({ product }) {
  ...
  useState(() => {
    ...
    fetch(`https://api.pexels.com/v1/search?query=${query}&per_page=1`, {
      ...
      .then(r => r.json())
      .then(data => {
        const img = data?.photos?.[0]?.src?.medium;
        if (img) setUrl(img);
        else setErr(true);
      })
      .catch(() => setErr(true));
  ...
  if (err || (!url && !PEXELS_KEY)) {
    return <div style={{ fontSize:40, textAlign:"center", marginTop: product.tag ? 16 : 8 }}>{product.img}</div>;
  }
  if (!url) {
    return <div style={{ height:120, background:"#f0f0f0", borderRadius:6, marginTop: product.tag ? 16 : 8 }} />;
  }
  return (
    <img
      src={url}
...
const PRODUCTS = [
  ...
  // KITCHEN (continued)
  { id: 178, name: "Cast Iron Dutch Oven 6-Quart", price: 49.99, rating: 4.9, reviews: 18234, swift: true, img: "🍲", tag: "Best Seller", category: "Kitchen" },
  { id: 179, name: "Mandoline Slicer with Safety Guard", price: 34.99, rating: 4.5, reviews: 9821, swift: true, img: "🔪", tag: "", category: "Kitchen" },
  { id: 180, name: "Copper Moscow Mule Mugs Set of 4", price: 39.99, rating: 4.7, reviews: 7432, swift: true, img: "🥂", tag: "Top Pick", category: "Kitchen" },
  { id: 181, name: "Pasta Maker Machine Manual", price: 44.99, rating: 4.6, reviews: 5231, swift: false, img: "🍝", tag: "", category: "Kitchen" },
  { id: 182, name: "Cold Brew Coffee Maker 1-Gallon", price: 29.99, rating: 4.7, reviews: 12043, swift: true, img: "☕", tag: "Best Seller", category: "Kitchen" },
  { id: 183, name: "Vitamix Blender 64oz Professional", price: 399.99, rating: 4.9, reviews: 31204, swift: true, img: "🥤", tag: "#1 Pick", category: "Kitchen" },
  { id: 184, name: "Wok Carbon Steel 14-Inch", price: 49.99, rating: 4.8, reviews: 8901, swift: true, img: "🍳", tag: "Top Pick", category: "Kitchen" },
  { id: 185, name: "Instant Pot Duo 8-Quart 7-in-1", price: 99.99, rating: 4.9, reviews: 52301, swift: true, img: "🍲", tag: "Best Seller", category: "Kitchen" },
  { id: 186, name: "Bread Proofing Basket Set of 2", price: 24.99, rating: 4.6, reviews: 6732, swift: true, img: "🍞", tag: "", category: "Kitchen" },
  { id: 187, name: "Milk Frother Electric Handheld", price: 12.99, rating: 4.7, reviews: 41023, swift: true, img: "☕", tag: "Best Seller", category: "Kitchen" },
  { id: 188, name: "Pizza Stone 15-Inch Cordierite", price: 34.99, rating: 4.7, reviews: 14320, swift: true, img: "🍕", tag: "Top Pick", category: "Kitchen" },
  { id: 189, name: "Espresso Machine 15-Bar", price: 149.99, rating: 4.7, reviews: 9821, swift: false, img: "☕", tag: "#1 Pick", category: "Kitchen" },
  { id: 190, name: "Salad Spinner Large 5-Quart", price: 29.99, rating: 4.6, reviews: 11203, swift: true, img: "🥗", tag: "", category: "Kitchen" },
  { id: 191, name: "Kitchen Shears Heavy Duty", price: 14.99, rating: 4.8, reviews: 22041, swift: true, img: "✂️", tag: "Best Seller", category: "Kitchen" },
  { id: 192, name: "Waffle Maker Belgian 4-Square", price: 44.99, rating: 4.7, reviews: 8732, swift: true, img: "🧇", tag: "Top Pick", category: "Kitchen" },

  // ELECTRONICS (continued)
  { id: 193, name: "Smart Home Hub WiFi 6 Router", price: 129.99, rating: 4.7, reviews: 14320, swift: true, img: "📡", tag: "Top Pick", category: "Electronics" },
  { id: 194, name: "4K Webcam with Ring Light", price: 89.99, rating: 4.6, reviews: 8901, swift: true, img: "📷", tag: "", category: "Electronics" },
  { id: 195, name: "Portable SSD 2TB USB-C", price: 109.99, rating: 4.8, reviews: 19203, swift: true, img: "💾", tag: "Best Seller", category: "Electronics" },
  { id: 196, name: "Smart Doorbell Camera 2K", price: 79.99, rating: 4.6, reviews: 22041, swift: true, img: "🔔", tag: "Top Pick", category: "Electronics" },
  { id: 197, name: "Wireless Keyboard and Mouse Combo", price: 49.99, rating: 4.7, reviews: 31204, swift: true, img: "⌨️", tag: "Best Seller", category: "Electronics" },
  { id: 198, name: "Smart Thermostat WiFi Programmable", price: 129.99, rating: 4.8, reviews: 18320, swift: true, img: "🌡️", tag: "#1 Pick", category: "Electronics" },
  { id: 199, name: "Curved Gaming Monitor 27-Inch 144Hz", price: 299.99, rating: 4.7, reviews: 9821, swift: false, img: "🖥️", tag: "Top Pick", category: "Electronics" },
  { id: 200, name: "Mechanical Pencil Set Premium 0.5mm", price: 24.99, rating: 4.6, reviews: 7432, swift: true, img: "✏️", tag: "", category: "Electronics" },
  { id: 201, name: "Smart Light Bulbs 4-Pack Color", price: 39.99, rating: 4.6, reviews: 28301, swift: true, img: "💡", tag: "Best Seller", category: "Electronics" },
  { id: 202, name: "Action Camera 4K Waterproof", price: 149.99, rating: 4.6, reviews: 12043, swift: true, img: "📷", tag: "Top Pick", category: "Electronics" },
  { id: 203, name: "Drone with 4K Camera Foldable", price: 299.99, rating: 4.5, reviews: 8732, swift: false, img: "🚁", tag: "#1 Pick", category: "Electronics" },
  { id: 204, name: "VR Headset Standalone 128GB", price: 399.99, rating: 4.7, reviews: 14320, swift: false, img: "🥽", tag: "Best Seller", category: "Electronics" },
  { id: 205, name: "Portable Charger 30000mAh Solar", price: 59.99, rating: 4.5, reviews: 9821, swift: true, img: "🔋", tag: "", category: "Electronics" },
  { id: 206, name: "Smart Watch AMOLED Always-On", price: 199.99, rating: 4.7, reviews: 22041, swift: true, img: "⌚", tag: "Top Pick", category: "Electronics" },
  { id: 207, name: "Soundbar 2.1 with Subwoofer 300W", price: 199.99, rating: 4.7, reviews: 11203, swift: false, img: "🔊", tag: "Best Seller", category: "Electronics" },

  // SPORTS (continued)
  { id: 208, name: "Kettlebell Cast Iron 35lb", price: 49.99, rating: 4.8, reviews: 8732, swift: false, img: "🏋️", tag: "Top Pick", category: "Sports" },
  { id: 209, name: "Indoor Cycling Bike Magnetic", price: 399.99, rating: 4.7, reviews: 7432, swift: false, img: "🚴", tag: "#1 Pick", category: "Sports" },
  { id: 210, name: "Treadmill Folding 3.0HP Motor", price: 599.99, rating: 4.6, reviews: 5231, swift: false, img: "🏃", tag: "Best Seller", category: "Sports" },
  { id: 211, name: "Boxing Gloves 16oz Training", price: 44.99, rating: 4.7, reviews: 9821, swift: true, img: "🥊", tag: "Top Pick", category: "Sports" },
  { id: 212, name: "Punching Bag Heavy Duty 70lb", price: 99.99, rating: 4.6, reviews: 6732, swift: false, img: "🥊", tag: "", category: "Sports" },
  { id: 213, name: "Rowing Machine Magnetic Resistance", price: 499.99, rating: 4.7, reviews: 4321, swift: false, img: "🚣", tag: "#1 Pick", category: "Sports" },
  { id: 214, name: "Battle Ropes 40ft 1.5-Inch", price: 59.99, rating: 4.6, reviews: 7432, swift: false, img: "💪", tag: "", category: "Sports" },
  { id: 215, name: "Gymnastic Rings Wood Adjustable", price: 34.99, rating: 4.7, reviews: 8901, swift: true, img: "🤸", tag: "Top Pick", category: "Sports" },
  { id: 216, name: "Weight Bench Adjustable Flat/Incline", price: 149.99, rating: 4.7, reviews: 11203, swift: false, img: "🏋️", tag: "Best Seller", category: "Sports" },
  { id: 217, name: "Climbing Hangboard Woody", price: 79.99, rating: 4.8, reviews: 3241, swift: false, img: "🧗", tag: "", category: "Sports" },
  { id: 218, name: "Badminton Set with Net Portable", price: 39.99, rating: 4.5, reviews: 6732, swift: true, img: "🏸", tag: "", category: "Sports" },
  { id: 219, name: "Soccer Ball Size 5 Match Quality", price: 29.99, rating: 4.7, reviews: 12043, swift: true, img: "⚽", tag: "Top Pick", category: "Sports" },
  { id: 220, name: "Basketball Official Size 7", price: 34.99, rating: 4.6, reviews: 9821, swift: true, img: "🏀", tag: "", category: "Sports" },
  { id: 221, name: "Tennis Racket Pro Control", price: 89.99, rating: 4.7, reviews: 5432, swift: true, img: "🎾", tag: "Top Pick", category: "Sports" },

  // HOME (continued)
  { id: 222, name: "Robot Vacuum with Mop 2700Pa", price: 299.99, rating: 4.7, reviews: 22041, swift: true, img: "🤖", tag: "Best Seller", category: "Home" },
  { id: 223, name: "Air Purifier HEPA H13 1500 sq ft", price: 199.99, rating: 4.8, reviews: 18320, swift: true, img: "💨", tag: "#1 Pick", category: "Home" },
  { id: 224, name: "Dehumidifier 50-Pint Energy Star", price: 229.99, rating: 4.6, reviews: 9821, swift: false, img: "💧", tag: "Top Pick", category: "Home" },
  { id: 225, name: "Heated Blanket Electric Dual Zone", price: 79.99, rating: 4.7, reviews: 14320, swift: true, img: "🛋️", tag: "Best Seller", category: "Home" },
  { id: 226, name: "Memory Foam Mattress Topper Queen", price: 99.99, rating: 4.8, reviews: 28301, swift: false, img: "🛏️", tag: "#1 Pick", category: "Home" },
  { id: 227, name: "Cordless Vacuum Stick 25kPa", price: 199.99, rating: 4.7, reviews: 19203, swift: true, img: "🌀", tag: "Best Seller", category: "Home" },
  { id: 228, name: "Portable Air Conditioner 10000 BTU", price: 399.99, rating: 4.5, reviews: 7432, swift: false, img: "❄️", tag: "", category: "Home" },
  { id: 229, name: "Smart Lock Keypad Fingerprint", price: 129.99, rating: 4.6, reviews: 11203, swift: true, img: "🔐", tag: "Top Pick", category: "Home" },
  { id: 230, name: "Lava Lamp Retro 14.5-Inch", price: 24.99, rating: 4.5, reviews: 8732, swift: true, img: "💡", tag: "", category: "Home" },
  { id: 231, name: "Tapestry Bohemian Wall Hanging 60x80", price: 19.99, rating: 4.5, reviews: 14320, swift: true, img: "🎨", tag: "", category: "Home" },
  { id: 232, name: "Indoor Fountain Tabletop Zen", price: 39.99, rating: 4.4, reviews: 6732, swift: true, img: "⛲", tag: "", category: "Home" },
  { id: 233, name: "Weighted Blanket 15lb 60x80", price: 69.99, rating: 4.8, reviews: 31204, swift: true, img: "🛋️", tag: "Best Seller", category: "Home" },
  { id: 234, name: "Fireplace Electric Freestanding", price: 199.99, rating: 4.6, reviews: 8901, swift: false, img: "🔥", tag: "Top Pick", category: "Home" },
  { id: 235, name: "Canopy Bed Frame Queen Boho", price: 299.99, rating: 4.6, reviews: 5231, swift: false, img: "🛏️", tag: "", category: "Home" },

  // GARDEN (continued)
  { id: 236, name: "Greenhouse Walk-In 6x8ft", price: 149.99, rating: 4.5, reviews: 4321, swift: false, img: "🌿", tag: "Top Pick", category: "Garden" },
